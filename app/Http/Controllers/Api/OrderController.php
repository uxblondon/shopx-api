        ...
        try {
            ...
            if ($shipping['method'] === 'delivery') {
                ...
                $order_address_data = array(
                    ...
                    'address_line_2' => isset($delivery_address['address_line_2']) ? $delivery_address['address_line_2'] : '',
                    'city' => $delivery_address['city'],
                    'county' => isset($delivery_address['county']) ? $delivery_address['county'] : '',
                ...
                $collection_address_data = array(
                    ...
                    'address_line_2' => isset($collection_address['address_line_2']) ? $collection_address['address_line_2'] : '',
                    'city' => $collection_address['city'],
                    'county' => isset($collection_address['county']) ? $collection_address['county'] : '',
            ...
            $billing_data = array(
                ...
                'address_line_2' => isset($billing['address_line_2']) ? $billing['address_line_2'] : '',
                'city' => $billing['city'],
                'county' => isset($billing['county']) ? $billing['county'] : '',
